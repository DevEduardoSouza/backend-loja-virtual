...
public class EmailService {
    ...
    @Autowired
    private Configuration fmCofiguration;

    @Value("${spring.mail.username}")
    private String remetente;
    public String enviarEmalTexto(String destinatario, String titulo, String mensagem){
    ...
    public String getConteudoTemplate(Map<String, Object> model){
        ...
        try {
            content.append(FreeMarkerTemplateUtils.processTemplateIntoString(fmCofiguration.getTemplate("email-recuperacao-codigo.flth"), model));
        } catch (Exception e){
            e.printStackTrace();
        }
